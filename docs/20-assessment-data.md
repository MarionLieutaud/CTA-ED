...
[Project Gutenberg](https://www.gutenberg.org/) is a library of over 75,000 free eBooks, with focus on older works for which U.S. copyright has expired. You can download text data from over 60,000 out-of-copyright books using the package [gutenbergr](https://cran.r-project.org/web/packages/gutenbergr/index.html). We used this package in [exercise 5](https://marionlieutaud.github.io/CTA-ED/exercise-5-unsupervised-learning-topic-models.html?q=gutenberg#setup-9), so you can use the code from that exercise as a starting point.

The ID for each book appears in the url for the book selected after a search on [https://www.gutenberg.org/ebooks/](https://www.gutenberg.org/ebooks/).
